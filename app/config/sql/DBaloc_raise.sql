...
INSERT INTO `datos_usuarios` (`id`, `id_usuario`, `plantilla`, `sw_menu_text`, `color_web1`, `color_web2`, `color_font`, `nombre_empresa`, `nombre_web`, `social_twitter`, `swtwitter`, `social_instagram`, `swinstagram`, `social_facebook`, `swfacebook`, `social_linkedin`, `swlinkedin`, `titulo_sobre_nosotros`, `sobre_nosotros`, `moneda`, `logo`, `portada`, `carta`, `carta_text`, `bebida`, `bebida_text`, `wifi_name`, `wifi_pass`, `swwifi`, `email`, `telefono`, `horario`, `ubicacion_google`, `direccion`, `codigo_postal`, `ciudad`, `estado`, `pais`, `aceptar_tarjetas`, `swaceptartarjetas`) VALUES
...
INSERT INTO `datos_personales` (`id`, `id_usuario`, `recuperar_password`, `email`, `nombre`, `apellidos`, `dni_nif`, `fecha_nacimiento`, `direccion`, `numero_direccion`, `planta`, `codigo_postal`, `ciudad`, `estado`, `pais`, `telefono`, `fecha_registro`, `ultima_conexion`, `plan`, `precio_plan`) VALUES
