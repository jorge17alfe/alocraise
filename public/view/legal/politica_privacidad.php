<article class="politica-primacidad container  text-justify py-5 pl-5 pr-3">
    ...
    El responsable y titular de este sitio web es <strong><?=config('autor-name').' '.config('autor-surname')?>.</strong>
        <br>
        ...
        <strong> Actividad del sitio web</strong>: distribución de contenido relacionado con web online, muestra de publicidad, y recomendación de productos de afiliado. <br>
        <strong> Correo electrónico</strong>: <?=config('email-info') ?> <br> <br>

        Los datos que nos facilites con tu consentimiento, y de acuerdo al uso establecido en esta Política de Privacidad, serán incorporados a un fichero automatizado debidamente inscrito en la Agencia Española de Protección de Datos, en el que el responsable de dicho fichero es: <?=SERVERURL?>. Esto quiere decir que tus datos están seguros, de acuerdo a lo que establece la ley.
        <br>

        Los datos personales que nos facilites, siempre con tu consentimiento expreso, se almacenarán y tratarán con los fines previstos y descritos a continuación en esta Política de Privacidad, hasta el momento en que nos pidas que los eliminemos.<br><br>
    ...
    <h5>REGISTRO Y FINALIDAD DE TUS DATOS</h5><br>
    <p>
        ...
        De ser así, te garantizamos que estos terceros nunca tendrán acceso a tus datos personales, con las excepciones reflejadas a continuación, siendo en todo caso estas comunicaciones realizadas por parte de <?=SERVERURL?>, como titular de la web.
        <br><br>
    ...
    <h5>EXACTITUD Y VERACIDAD DE LOS DATOS</h5><br>
    <p>
        Como usuario, eres el único responsable de la veracidad y modificación de los datos que remitas a <?=SERVERURL?>, exonerándonos de cualquier responsabilidad al respecto.
        <br><br>
    ...
    <h5>BAJAS DE SUSCRIPCIÓN Y DERECHO DE REVOCACIÓN</h5>
    <br>
    <p>

        Como titular de los datos que nos hayas facilitado, podrás ejercer en cualquier momento tus derechos de acceso, rectificación, cancelación y oposición, enviándonos un correo electrónico a <?=config('email-info') ?> y adjuntándonos una fotocopia de tu documento de identidad como prueba válida.
        <br><br>

        Igualmente, podrás darte de baja en cualquier momento para dejar de recibir nuestra newsletter o cualquier otra comunicación comercial, directamente desde el mismo email que hayas recibido o enviándonos un correo a <?=config('email-info') ?>.
    </p>
    <br><br>

    <h5>ACCESO A DATOS POR CUENTA DE TERCEROS</h5><br>
    <p>
        ...
        Este sitio web está alojado en <a href="https://ionos.com/">https://ionos.com/</a>, con marca comercial Ionos, que proporciona los servicios de hosting para que puedas acceder y navegar por nuestro sitio. Puedes consultar la política de privacidad y demás aspectos legales de esta empresa en el siguiente enlace: <a href="https://www.ionos.com/terms-gtc/terms-privacy/">https://www.ionos.com/terms-gtc/terms-privacy/</a>.
        <br><br>
        ...
        Google Analytics es un servicio analítico de web prestado por Google, Inc., una compañía de Delaware cuya oficina principal está en 1600 Amphitheatre Parkway, Mountain View (California), CA 94043, Estados Unidos (“Google”).<br><br>
        ...
        Si quieres saber más sobre el uso de cookies y las prácticas de recopilación de información y los procedimientos de aceptación o rechazo, consulta nuestra <a href="<?=SERVERURL?>politica-cookies">POLÍTICA DE COOKIES</a>.
    ...
    <br>
    <p>
        Como titular de la web, <?=SERVERURL?> ha adoptado todas las medidas técnicas y de organización necesaria para garantizar la seguridad e integridad de los datos de carácter personal que trate, así como para evitar su pérdida, alteración y/o acceso por parte de terceros no autorizados.
        <br><br>

        Te recordamos que, para más información, puedes consultar nuestras páginas de <a href="<?=SERVERURL?>aviso-legal">AVISO LEGAL</a> y <a href="<?=SERVERURL?>politica-cookies">POLÍTICA DE COOKIES</a>.
    </p>
</article>
