<article class="aviso-legal container  text-justify py-5 pl-5 pr-3">
    ...
    <p>Este Aviso Legal tiene el objetivo de informarte de tus derechos y obligaciones como usuario de este sitio web. Aquí encontrarás toda la información que necesitas sobre este sitio web, su actividad, los datos personales que recaba y su finalidad, así como las normas de uso que regulan el uso de esta web.
        <br><br>
        En el momento en que accedas a este sitio web <?= SERVERURL ?>, asumes la condición de usuario, por lo que el contenido de este Aviso Legal te afecta directamente. Por eso, es importante que lo leas para disipar cualquier duda que puedas tener y tener conocimiento de causa sobre las condiciones que estás aceptando.
        <br><br>
    ...
    <h5>DATOS DE IDENTIFICACIÓN</h5><br>
    <p>El responsable y titular de este sitio web es <strong><?= config('autor-name') . ' ' . config('autor-surname') ?>.</strong>
        <br>
        <strong>Nombre</strong>: <?= config('autor-name') . ' ' . config('autor-surname') ?><br>
        <strong>NIF</strong>: <?= config('nif') ?><br>
        <!-- <strong> Domicilio Social</strong>: C/ FELIP II, 279-281. 08016-BARCELONA <br> -->
        <strong> Actividad del sitio web</strong>: distribución de contenido relacionado con web online gratuita, muestra de publicidad, y recomendación de productos de afiliado. <br>
        <strong> Correo electrónico</strong>: <?= config('email-info') ?> <br>
        Los datos que nos facilites con tu consentimiento, y de acuerdo al uso establecido en nuestra Política de Privacidad, serán incorporados a un fichero automatizado debidamente inscrito en la Agencia Española de Protección de Datos, en el que el responsable de dicho fichero es: <?= config('title') ?>. Esto quiere decir que tus datos están seguros, de acuerdo a lo que establece la ley.
    </p><br><br>
    <h5>NORMAS DE ACCESO AL SITIO WEB</h5> <br>
    <p> Como usuario de nuestra web, también tienes una serie de obligaciones:
        <br><br>
    ...
    <p>La totalidad de este sitio web (texto, imágenes, marcas, gráficos, logotipos, botones, archivos de software, combinaciones de colores, así como la estructura, selección, ordenación y presentación de sus contenidos) se encuentra protegida por las leyes vigente sobre Propiedad Intelectual e Industrial, quedando prohibida su reproducción, distribución, comunicación pública y transformación, salvo para uso personal y privado.
        <br><br>
        Como titular de este sitio web "<?= SERVERURL ?>", no garantiza que los contenidos sean precisos o libres de error o que el libre uso de los mismos por parte de los usuarios no infrinja los derechos de terceras partes. El buen o mal uso de esta página y de sus contenidos es responsabilidad del usuario.
        <br><br>
        Asimismo, queda prohibida la reproducción, retransmisión, copia, cesión o redifusión, total o parcial, de la información contenida en la página, cualquiera que fuera su finalidad y el medio utilizado para ello, sin autorización previa de "<?= config('title') ?>".
    </p><br><br>
    <h5>ENLACES O LINKS</h5> <br>
    <p> Este sitio web incluye enlaces o links a sitios de terceros. Las páginas pertenecientes a estos terceros no han sido revisadas ni son objeto de controles por nuestra parte, por lo que <?= SERVERURL ?> no podrá ser considerado responsable de los contenidos de estos sitios web, ni de las medidas que se adopten relativas a su privacidad o al tratamiento de sus datos de carácter personal u otros que pudieran derivarse.
        <br><br>
    ...
    <h5>ENLACES DE AFILIACIÓN DE AMAZON</h5><br>
    <p>Este sitio web, de acuerdo a su finalidad, utiliza enlaces de afiliado de Amazon.
        <br><br>
    ...
    <h5>LIMITACIÓN DE RESPONSABILIDAD</h5><br>
    <p>En ejercicio de su derecho como titular de esta web, te informamos de que <?= SERVERURL ?> no se hace responsable en ningún caso de lo siguiente:
        <br><br>
    ...
    <h5>POLITICA DE PRIVACIDAD Y PROTECCIÓN DE DATOS</h5><br>
    <p>Este sitio web cumple con la normativa vigente en materia de protección de datos, lo que implica que, como usuario, deberás dar tu consentimiento expreso antes de facilitarnos datos personales a través de los diferentes formularios puestos a disposición en las secciones de nuestra página.
        <br><br>
        ...
        <br><br>
        Toda esta información la podrás encontrar en nuestra <a href="<?= SERVERURL ?>politica-privacidad">POLITICA DE PRIVACIDAD</a>.
    </p><br><br>
    <h5>POLÍTICA DE COOKIES</h5><br>
    <p> Tal y como te informamos nada más acceder a nuestra web, este sitio utiliza cookies propias y de terceros con el objetivo de proporcionarte la mejor experiencia de usuario y desarrollar nuestra actividad.
        <br><br>
        ...
        <br><br>
        Para acceder a la información completa sobre el uso de cookies en este sitio web, su finalidad y su desestimación, puedes consultar nuestra <a href="<?= SERVERURL ?>politica-cookies">POLÍTICA DE COOKIES</a>.
    </p><br><br>
    <h5>LEGISLACIÓN APLICABLE Y JURISDICCIÓN COMPETENTE</h5><br>
    <p>El presente Aviso Legal se encuentra sometido a la legislación española vigente.
        <br><br>
        En caso necesario, ante cualquier tipo de controversia de carácter legal, <?= config('title') ?> y el usuario, con renuncia expresa a cualquier otro fuero, se someterán a los Juzgados y Tribunales del domicilio del Usuario para cualquier controversia que pudiera derivarse.
        <br><br>
        En el caso de que el usuario tenga su domicilio fuera de España, <?= config('title') ?> y el usuario se someterán, con renuncia expresa a cualquier otro fuero, a los juzgados y tribunales de Madrid (España).
        <br><br>
        Si tienes cualquier duda sobre este Aviso Legal, puedes enviarnos un correo electrónico a <?= config('email-info') ?> .
    </p><br><br>
</article>