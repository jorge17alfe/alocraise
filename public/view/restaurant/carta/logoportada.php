...
<div id="main_portada" class="row mb-4 pr-0 col-md-12 col-12 border-top pt-2">
    ...
    <a href='javascript:void[0]' onclick="hideShowSection('portada','PORTADA')" id="btn_show_portada" class="btn_show_section btn-sm col-md-3 col-sm-4 col-5 my-3">VER PORTADA</a>
