...
<div id="main_carta" class="row mb-4 pr-0 col-md-12 col-12 border-top pt-2 ">
    ...
    <a href='javascript:void[0]' onclick="hideShowSection('carta')" id="addcarta" class=" btn-sm col-md-3 col-sm-4 col-5 my-3">ver carta</a>
...
<div id="main_bebida" class="row pr-0 col-md-12 col-12 border-top pt-2 ">
    ...
    <a href='javascript:void[0]' onclick="hideShowSection('bebida')" id="addbebida" class=" btn-sm col-md-3 col-sm-4 col-5 my-3">ver bebida</a>
            ...
            success: function(response) {
                    ...
                    for (var a = 0; a < result.length; a++) {
                        ...
                        if (task.data[section2[s]][a].length > 1) {
                            ...
                            for (var i = 1; i < task.data[section2[s]][a].length; i++) {
                                ...
                                index += "<a href='javascript:void[0]' onclick='showalergenos(\"" + section2[s] + "\"," + a + "," + i + ")' id='' class='btn_vermas" + section2[s] + a + i + " text-info ' ><small>ver +</small></a>"
                                ...
                                for (var o = 3; o < 17; o++) {
                                    ...
                                    index += "</div>"
                                    index += "<div  class='col-12' style='height:45px;'>"
                                    ...
                                    index += " id='alergenos" + section2[s] + a + i + o + "'  type='checkbox' name='datos_textos[" + section2[s] + "][" + a + "][" + i + "][" + o + "]' class='position-relative mb-0' style='width:15px; top:-23px; right:-15px;' value='" + alergenos[o] + "'>"
                                    index += "</div>"
                                    index += "</div>"
                                }
                                index += "</div>"
                ...
                for (var a = 0; a < section.length; a++) {
                    for (var i = [task.data[section[a]].length - 1]; i >= 0; --i) {
                        addlinea(task.data.id_usuario, task.data[section[a]][i], i, [section[a]])
                    }
                }

                function addlinea(user, image, i, data) {
