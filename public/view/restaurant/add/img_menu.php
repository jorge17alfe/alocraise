<div id="main_img_menu" class="row mb-4 pr-0 col-md-12 col-12 border-top ">
    <form id='send_imageimg_menu' class='send_image row col-12 my-5 justify-content-center'>
        ...
        <label for='' class='label col-form-label-sm text-right col-md-2 col-5 mr-2'> Editar imagen  <input name='img_menu[img_menu][]' id='img_menu' type='file' class='img_menu mt-1 input-sm form-control'></label>
